...
#  lambda_env_vars = {
#    stage                   = var.stage
#    TARGET_DATA_BUCKET_NAME = module.source_code_bucket.s3_bucket           # Demo bucket where we will copy the raw data
#    TARGET_DATA_BUCKET_PATH = "s3://${module.source_code_bucket.s3_bucket}" # Target bucket path
#  }
#
#  tags_lambda = {
